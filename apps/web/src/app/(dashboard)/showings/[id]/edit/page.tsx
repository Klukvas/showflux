...
interface EditShowingPageProps {
  readonly params: Promise<{ id: string }>;
}

export default function EditShowingPage({ params }: EditShowingPageProps) {
  const { id } = use(params);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Edit Showing" />
      <ShowingForm showing={showing} />
    </div>
  );
}
